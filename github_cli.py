...
class GitHubCLI:
    ...
    def parse_arguments(self) -> None:
        ...
        parser = ArgumentParser(prog="github-cli")
    ...
    def handle_event(self, args: Namespace):
        ...
        match vars(args):
            ...
            case {"repo": repo_full_name, "received": True}:
                print("github-cli event: error: argument --received: not allowed with argument --repo")
                return
            ...
            case _:
                print("github-cli event: error: either --user or --repo argument is required.")
                return
        Event(
            endpoint,
            path_params=params,
